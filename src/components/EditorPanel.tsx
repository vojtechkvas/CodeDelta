...
export const EditorPanel = ({
  ...
  //  blue
  <div
    className={`bg-slate-800/50 backdrop-blur rounded-xl border border-slate-700 shadow-2xl p-4 transition-all hover:border-${colorClass}`}
  >
    <h2
      className={`text-xl font-semibold mb-3 flex items-center gap-2 text-${colorClass}`}
    >
      {title}
    </h2>
    <textarea
